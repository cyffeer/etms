...
const routes: Routes = [
  ...
  { path: 'types/new', component: NihongoTypeFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },
  { path: 'types/:npTypeId/edit', component: NihongoTypeFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },
];

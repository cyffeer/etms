...
const routes: Routes = [
  ...
  { path: 'new', component: NpLvlInfoFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN'] } },
  { path: ':npLvlInfoId/edit', component: NpLvlInfoFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN'] } },

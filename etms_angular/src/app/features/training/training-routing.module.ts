...
const routes: Routes = [
  ...
  { path: 'info/new', component: TrngInfoFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },
  { path: 'info/:trngInfoId/edit', component: TrngInfoFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },
  { path: 'history', component: TrngHistListPageComponent },
  { path: 'history/new', component: TrngHistFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },
  { path: 'history/:trngHistId/edit', component: TrngHistFormPageComponent, canActivate: [AuthGuard], data: { roles: ['ADMIN', 'HR'] } },

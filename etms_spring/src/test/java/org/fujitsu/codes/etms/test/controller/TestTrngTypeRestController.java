...
class TestTrngTypeRestController {

    @Test
    void shouldHaveBaseMappingAndGetEndpoint() {
        TrngTypeRestController controller = instantiate(TrngTypeRestController.class);
        assertNotNull(controller);
        assertNotNull(TrngTypeRestController.class.getAnnotation(RequestMapping.class));

        boolean hasGet = Arrays.stream(TrngTypeRestController.class.getDeclaredMethods())

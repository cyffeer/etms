...
class TestTrainingHistoryRestController {

    @Test
    void shouldHaveBaseMappingAndGetEndpoint() {
        TrainingHistoryRestController controller = instantiate(TrainingHistoryRestController.class);
        assertNotNull(controller);
        assertNotNull(TrainingHistoryRestController.class.getAnnotation(RequestMapping.class));

        boolean hasGet = Arrays.stream(TrainingHistoryRestController.class.getDeclaredMethods())
